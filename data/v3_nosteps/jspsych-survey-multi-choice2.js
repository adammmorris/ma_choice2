...
jsPsych.plugins['survey-multi-choice2'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      preamble_two: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Preamble-two',
        default: null,
        description: 'HTML formatted string to display at the top of the page above all the questions.'
      },
      left_most_option: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'left_aligned',
        default: null,
      },
      right_most_option: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'right_aligned',
        default: null,
      },
      button_label: {
        type: jsPsych.plugins.parameterType.STRING,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // indented
    html += '<div class="preamble-2">'+trial.preamble_two+'</div>'
    ...
    html+= '<p style="text-align:left;">'
            +trial.left_most_option+
            '<span style="float:right;">'
            +trial.right_most_option+
            '</span>\
            </p>'
    html +='</div>'
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      //create two colums that floats next to eachother
      html += '<div class="row">'
      //question prompt column
      html += '<div class="column left" style="background-color:#fff;">' + question.prompt
      ...
      html+= '</div>'
      //options column
      html += '<div class="column right" style="background-color:#fff;">'
